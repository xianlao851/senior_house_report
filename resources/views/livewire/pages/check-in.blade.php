...
<div class="">
    ...
    <div class="p-4 mt-4">
        @if ($errors->first())
            <div class="relative flex flex-col max-w-6xl p-3 mx-auto alert alert-error">
                <div>
        ...
        @endif
        {{-- <div>
            <button wire:click='deleteCheckMo()' class="btn btn-secondary btn-sm">Click here</button>
        </div> --}}
        {{-- <div class="relative flex flex-col max-w-6xl mx-auto my-12">
        ...
        <div class="relative flex flex-col max-w-6xl p-3 mx-auto bg-white rounded">
                                ...
                                <tr class="uppercase">
                                    ...
                                    @endif --}}
                                        ...
                                        @foreach ($department->checked_in_mo($current_detail->id)->get() as $checkin_mo)
                                            ...
                                            @endif
                                            @if ($getDiffHours <= 18)
                                                <label for="" class="cursor-pointer hover:underline"
                                                    title="Delete?"
            ...
            {{-- start coding here for new table --}}
                                    ...
                                    <tr>
                                        ...
                                        <td class="border">
                                            <label class="btn btn-xs btn-secondary"
                                                ...
                                                title="Edit?" for="editTransferFrom" wire:click="editTransferFrom('{{ $transfer->id }}','{{ $transfer->diagnosis }}','{{ $transfer->facility }}','{{ $transfer->reason }}','{{ $transfer->patient_id }}','{{ $transfer->sho_id }}')"
                                                @else
            ...
            <!-- Modal for adding transfer from -->
                    ...
                    <div class="">
                        <div class="w-full p-2"> <!-- For searching patient info, for adding transfer from-->
                            <div class="w-full join">
                                ...
                                {{-- <select class="select select-bordered join-item" wire:model='get_option'>
                                    <option>Filter</option>
                                    <option value="hpercode">Hospital No.</option>
                                    <option value="patlast">Last name</option>
                                    <option value="patfirst">First name</option>
                                </select> --}}
                                <div class="indicator">
                                    <button class="w-20 text-white bg-green-700 btn join-item">Search </button>
                                    {{-- wire:click='searchpatient'>Search</button> --}}
